...
### Notes: This challenge centers around web scraping and the analysis following successful extraction of data from the source website pages. The first component is focused around titles and text. The main goal is to extract titles and previews and also store it as a list of dictionaries. The second component is the weather and analysis. The source website for that particular component is a table containing statistical data and properties of the Mars temperatures and orbiting cycles. The data needs to be extracted as a dataframe prior to using that same dataframe to answer a series of questions through plotting various bar charts and graphs. 
